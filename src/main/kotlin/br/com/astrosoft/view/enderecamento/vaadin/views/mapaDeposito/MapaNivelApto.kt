...
class MapaNivelApto(private val model: MapaNiveisAptosModel): CssLayout() {
  ...
  private fun buildLayout(layoutLado: LayoutLado, predio: RepositorioPredio) {
    ...
    niveis.forEach {nivel ->
      ...
      val lblNivel = Label(nivel.nivel)
    ...
    val lblPredio = Label(predio.predio)
